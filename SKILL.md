...
🔴 {加项ItemID} {加项名称} ¥{价格}
   适用人群：{从 evidence_mappings_2025.json 读取 age_recommendation}
   依据：《成人健康体检项目推荐指引（2025年版）》
   {从 evidence_mappings_2025.json 读取 evidence}
   收益：{从 evidence_mappings_2025.json 读取 benefit}
